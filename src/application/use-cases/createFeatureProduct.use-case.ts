...
@Injectable()
export class CreateFeatureProductUseCase {
  constructor(
  ...
  async execute(
    createFeatureProductDTO: CreateFeatureProductDTO,
  ): Promise<FeatureProductEntity> {
    return await this.featuresRepository.createFeatureProduct(
      createFeatureProductDTO,
    );
  }
}
